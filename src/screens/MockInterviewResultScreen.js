...
// Mock result data - replace with actual API data
...
export default function MockInterviewResultScreen({ route, navigation }) {
  ...
  const result = MOCK_RESULT_DATA; // Replace with actual data
    ...
    <SafeAreaView style={styles.safeArea} edges={["left", "right"]}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.sessionTitle}>{session.title || "Mock Interview"}</Text>
        </View>
